...
struct GLOBAL 
{
	...
	int VidFormat;         //0-AVI 1-MKV 2-WebM....
	...
	gboolean add_ctrls;    //flag for exiting after adding extension controls
       ...
       int Meta_enable; //Enable/disable metadata capturing
	int XImuDeviceCB_idx;
	int EncoderDeviceCB_idx;
	int EncoderRateCB_idx;
	int TensoDeviceCB_idx;
	int TensoRateCB_idx;    
        //Enabled channels in Tenso Bridge
       int tenso_enabled_ch_0;
       int tenso_enabled_ch_1;
       int tenso_enabled_ch_2;
       int tenso_enabled_ch_3;
