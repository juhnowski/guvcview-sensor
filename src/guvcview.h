...
struct GWIDGET 
{
	...
	gboolean vid_widget_state;
       ...
       GtkWidget *MetaEnableCB;
	GtkWidget *label_XImuDevice;
	GtkWidget *XImuDeviceCB;
	GtkWidget *label_EncoderDevice;
	GtkWidget *EncoderDeviceCB;
	GtkWidget *label_EncoderRate;
	GtkWidget *EncoderRateCB;
	GtkWidget *label_TensoDeviceCB;
	GtkWidget *TensoDeviceCB;
	GtkWidget *label_TensoRateCB;
	GtkWidget *TensoRateCB;
	GtkWidget *label_TensoChannels;
	GtkWidget *table_TensoChannels;
	GtkWidget *TensoChannTB_0;
	GtkWidget *TensoChannTB_1;
	GtkWidget *TensoChannTB_2;
	GtkWidget *TensoChannTB_3;

       GtkWidget *XImuPropBtn;
       GtkWidget *EncoderPropBtn;
       GtkWidget *TensoPropBtn;
       
	GtkTextBuffer *ximu_buffer;
       GtkTextBuffer *tenso_buffer;
       GtkTextBuffer *encoder_buffer;
};
...
struct ALL_DATA 
{
	...
	__THREAD_TYPE ximu_thread;
	__THREAD_TYPE tenso_thread;
	__THREAD_TYPE encoder_thread;
};
