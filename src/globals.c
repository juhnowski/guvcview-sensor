...
int initGlobals (struct GLOBAL *global) 
{
	...
	global->add_ctrls = FALSE;
       ...
       global->Meta_enable = TRUE;
       global->XImuDeviceCB_idx = 0;
       global->TensoDeviceCB_idx = 0;
       global->EncoderDeviceCB_idx = 0;
       global->EncoderRateCB_idx = 0;
       global->tenso_enabled_ch_0 = FALSE;
       global->tenso_enabled_ch_1 = FALSE;
       global->tenso_enabled_ch_2 = FALSE;
       global->tenso_enabled_ch_3 = FALSE;
